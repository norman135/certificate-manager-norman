...
const CertificateSettings: FC <CertificateSettingsProps> = ({certificateId, certificateIndex}): JSX.Element => {
    ...
    return (
        <div className="certificate-edit-button" tabIndex={0}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="32" height="32" className='edit-icon'>

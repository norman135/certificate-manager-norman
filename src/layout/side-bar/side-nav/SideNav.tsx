	...
	return (
		<div className="side-nav">
			<SideNavItem
				...
				svgVB="0 0 576 512"
				itemName={language === Languages.English ? 'Start' : 'Beginnen'}
				to={AppRoutes.Root}
				subMenu={[]}
			...
			<SideNavItem
				...
				subMenu={[
					{
						text: language === Languages.English ? 'Example 1' : 'Beispiel 1',
						to: AppRoutes.Example1,
					},
					{
						text: language === Languages.English ? 'Example 2' : 'Beispiel 2',
						to: AppRoutes.Example2,
					},
					{
						text: language === Languages.English ? 'Example 3' : 'Beispiel 3',

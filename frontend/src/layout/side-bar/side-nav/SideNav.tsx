	...
	return (
		<div className="side-nav">
			<SideNavItem
				...
				svgVB="0 0 576 512"
				itemName={toSelectedLocale('start', language)}
				to={AppRoutes.Root}
				subMenu={[]}
			...
			<SideNavItem
				...
				svgVB="0 0 448 512"
				itemName={toSelectedLocale('machineLearning', language)}
				to="#"
				subMenu={[
					{
						text: `${toSelectedLocale('example', language)} 1`,
						to: AppRoutes.Example1,
					},
					{
						text: `${toSelectedLocale('example', language)} 2`,
						to: AppRoutes.Example2,
					},
					{
						text: `${toSelectedLocale('example', language)} 3`,
